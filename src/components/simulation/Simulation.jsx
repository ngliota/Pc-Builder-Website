...
const Simulation = ({ userid }) => {
    ...
    useEffect(() => {
        // Reset motherboard selection when CPU changes
    ...
    const handleSave = () => {
        if (selectedMotherboard !== '') {
            ...
            console.log("Saving to database:", selectedComponents);
            // Implement actual database logic as needed
        } else {
            ...
            <div className='container experience__container'>
                <div className='experience__frontend'>
                    ...
                    <div className="experience__footer">
                        ...
                        <button className="btn btn-save" onClick={handleSave} disabled={selectedMotherboard === ''}>Save</button>
                    </div>
